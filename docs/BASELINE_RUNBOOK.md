...
- **Secrets/keys:** `STATGATE_REGISTRY_JWT_SECRET`, `STATGATE_INTERNAL_API_KEY`, `FLASK_SECRET_KEY`, `STATIOT_GATEWAY_SECRET`, `STATCOLLECT_API_KEY`, `STATCOLLECT_ADMIN_KEYS`, `REDIS_PASSWORD`, `MINIO_ROOT_PASSWORD`, `BASIC_AUTH_PASSWORD`, `SUPERSET_SECRET_KEY`
