...
2. **Stage 2 — Identity/security closure:** workspace context propagation into remaining later-phase services; extend the tenant-scope test pattern beyond PMS/RMS/Enterprise.
