...
const SupportTickets = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await API.post('/t/tickets/upload', formData, {
                headers: {
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Operations Work Queue</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><Link to="/ict/tickets">Work Items</Link></li>
                                <li class="breadcrumb-item active">Operations Queue</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="text-sm-end">
                                ...
                                >
                                    Bulk Upload Work Items <i className="mdi mdi-arrow-right ms-1"></i>
                                </label>
